...
```package-install
npm uninstall basehub --filter @jasonmorganson/cms
```

... and install the new dependencies...

```package-install
npm install @content-collections/mdx fumadocs-core --filter @jasonmorganson/cms
npm install -D @content-collections/cli @content-collections/core @content-collections/next --filter @jasonmorganson/cms
```
...
export { default } from '@jasonmorganson/cms/collections';
```
...
Finally, remove all instances of `BASEHUB_TOKEN` from the `@jasonmorganson/env` package.
