...
```package-install
npm install node-appwrite appwrite --filter @jasonmorganson/storage
```
...
import { storage, Permission, Role } from '@jasonmorganson/storage';
...
```ts
import { storage, bucketId, ID, InputFile } from '@jasonmorganson/storage';
...
```ts
import { storage, ID } from '@jasonmorganson/storage/client';
...
```ts
import { storage, bucketId } from '@jasonmorganson/storage';
...
```tsx
// Before (Vercel Blob)
import { put, del } from '@jasonmorganson/storage';
...
```ts
import { storage, bucketId, ID, Permission, Role, InputFile } from '@jasonmorganson/storage';
