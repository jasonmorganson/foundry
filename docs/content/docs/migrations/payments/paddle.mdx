...
```package-install
npm uninstall stripe --filter @jasonmorganson/payments
```

... and install the new dependencies...

```package-install
npm install @paddle/paddle-node-sdk --filter @jasonmorganson/payments
```
...
import { keys } from '@jasonmorganson/payments/keys';
import { NextResponse } from 'next/server';
import { headers } from 'next/headers';
import { paddle } from '@jasonmorganson/payments';
...
```package-install
npm install @paddle/paddle-js --filter @jasonmorganson/payments
```
...
import { usePaddle } from '@jasonmorganson/payments/checkout';
