...
next-forge provides a `Status` component from `@jasonmorganson/observability` that displays the current status of the application. You can see an example of this in the website footer.
