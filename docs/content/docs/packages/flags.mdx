...
To use the flag in your application, simply import it from the `@jasonmorganson/feature-flags` package and use it like a normal boolean value.

```tsx title="page.tsx"
import { showAnalyticsFeature } from '@jasonmorganson/feature-flags';
